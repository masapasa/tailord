...
export default function Blog({ allArticlesData }: { allArticlesData: any }) {
  ...
  return (
    <>
      <NextSeo
        title="Blog | Tailord"
        description="Read recent blog posts from Tailord"
      />
        ...
        <div className="flex flex-col-reverse sm:flex-row items-start">
          <div className="flex flex-col">
            ...
            <h2 className="text-gray-700 dark:text-gray-200 mb-4 mt-4">
              {"We've"} been writing articles about our latest work and {"We've"} worked on diverse projects.
              <br />
              <br />
              Dear reader should you be looking to open a dialogue about our
              availability on the topics outlined in our articles, please do so!{" "}
              {"We're"} always happy to chat, and can be reached via my email,
              info@nubri.co or by leaving a comment!
            </h2>
